/* 
    ...
    Because this is a template, all we'll do is render a solid green window.
    It's up to you to make this into anything worth while.
    
    `vulkan.org` has good sources: 
        https://www.vulkan.org/learn#vulkan-tutorials
        https://www.vulkan.org/learn#new-to-graphics-programming
...
main(int argc, char **argv)
{
    ...
    {
        if(strcmp(argv[i], "--max-frames-in-flight") == 0) {
            if(argc >= i + 1) {
                game.vk.max_frames = (unsigned int)strtol(argv[i + i], 
                                                            (char **)NULL, 
                                                            10);
    ...
    // Wait until the device is idle, prevents validation layers from complaining
...
clean_up(void)
{
    ...
    for(unsigned int i = 0; i < game.vk.max_frames; i++)
    {
        ...
        vkDestroySemaphore(game.vk.device, game.vk.render_finished[i], NULL);
...
//
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap6.html - Command buffers
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap7.html - Synchronization and Cache Control
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap8.html - Render Pass
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap19.html - Clear Commands
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap27.html - Fixed-Function Vertex Post-Processing
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap29.html - Fragment Operations
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap34.html - Window System Integration (WSI)
void
render(void)
{
...
// I have a feeling there is already a function for this
// But I couldn't be bothered to find it
void
vk_error_print(VkResult error)
{
    switch(error)
...
//
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap44.html - Extending Vulkan
bool
vk_supports_validation_layers(void)
{
    // Get layers
...
//
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap4.html - Initialization
bool
vk_create_instance(void)
{
    // Set app info
...
// and https://vulkan-tutorial.com/Drawing_a_triangle/Presentation/Window_surface
//
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap5.html - Devices and Queues
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap34.html - Window System Integration (WSI)
bool
vk_get_queue_families(
    VkPhysicalDevice device,
...
// See https://vulkan-tutorial.com/Drawing_a_triangle/Setup/Logical_device_and_queues
//
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap5.html - Devices and Queues
...
// It gives you a basic over look, but for this template it didn't help much
//
// Also see https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap7.html - Synchronization and Cache Control
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap8.html - Render Pass
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap12.html - Resource Creation
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap34.html - Window System Integration (WSI)
// 
bool
vk_recreate_swapchain()
...
// See https://vulkan-tutorial.com/Drawing_a_triangle/Graphics_pipeline_basics/Render_passes
//
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap8.html - Render Pass
bool
vk_create_render_pass(void)
...
// See https://vulkan-tutorial.com/Drawing_a_triangle/Graphics_pipeline_basics/Shader_modules
// and https://vulkan-tutorial.com/Drawing_a_triangle/Graphics_pipeline_basics/Fixed_functions
// and https://vulkan-tutorial.com/Drawing_a_triangle/Graphics_pipeline_basics/Conclusion
//
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap9.html - Shaders
// and https://registry.khronos.org/vulkan/specs/1.3-extensions/html/chap10.html - Pipelines
bool
vk_create_graphics_pipeline(void)
{
    // Create shaders
